...
from adapter_transformers import AutoTokenizer, PegasusConfig, is_tf_available
...
if is_tf_available():
    ...
    from adapter_transformers import TFAutoModelForSeq2SeqLM, TFPegasusForConditionalGeneration, TFPegasusModel

...
from adapter_transformers import LayoutLMTokenizer, LayoutLMTokenizerFast
from adapter_transformers.models.layoutlm.tokenization_layoutlm import VOCAB_FILES_NAMES

...
if is_torch_available():
    ...
    from adapter_transformers import FSMTConfig, FSMTForConditionalGeneration, FSMTModel, FSMTTokenizer
    from adapter_transformers.models.fsmt.modeling_fsmt import (
        SinusoidalPositionalEmbedding,
        _prepare_fsmt_decoder_inputs,
        invert_mask,
        shift_tokens_right,
    )
    from adapter_transformers.pipelines import TranslationPipeline

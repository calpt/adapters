...
from adapter_transformers import T5Config, is_tf_available
...
if is_tf_available():
    ...
    from adapter_transformers import ByT5Tokenizer, T5Tokenizer, TFT5EncoderModel, TFT5ForConditionalGeneration, TFT5Model

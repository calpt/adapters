...
from adapter_transformers import ViTConfig, is_flax_available
...
if is_flax_available():
    ...
    import jax
    from adapter_transformers.models.vit.modeling_flax_vit import FlaxViTForImageClassification, FlaxViTModel

...
from adapter_transformers import AutoTokenizer, MarianConfig, MarianTokenizer, TranslationPipeline, is_tf_available
...
if is_tf_available():
    ...
    from adapter_transformers import TFAutoModelForSeq2SeqLM, TFMarianModel, TFMarianMTModel

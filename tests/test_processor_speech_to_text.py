...
from adapter_transformers import Speech2TextTokenizer, is_speech_available
from adapter_transformers.file_utils import FEATURE_EXTRACTOR_NAME
from adapter_transformers.models.speech_to_text.tokenization_speech_to_text import VOCAB_FILES_NAMES, save_json
from adapter_transformers.testing_utils import require_sentencepiece, require_torch, require_torchaudio

from .test_feature_extraction_speech_to_text import floats_list


if is_speech_available():
    from adapter_transformers import Speech2TextFeatureExtractor, Speech2TextProcessor

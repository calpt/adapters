...
from adapter_transformers.testing_utils import require_tf, require_torch, slow
...
class TestCodeExamples(unittest.TestCase):
    def analyze_directory(
        ...
        for file in files:
            ...
            if only_modules:
                ...
                try:
                    module_identifier = getattr(adapter_transformers, module_identifier)
    ...
    def test_modeling_examples(self):
        transformers_directory = Path("src/adapter_transformers")
        files = "modeling"
        ignore_files = [
            "modeling_ctrl.py",
            "modeling_tf_ctrl.py",

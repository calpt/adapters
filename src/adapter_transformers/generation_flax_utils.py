...
class FlaxGenerationMixin:
    ...
    :class:`~adapter_transformers.FlaxPreTrainedModel`.
    """
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        name inside the :class:`~adapter_transformers.PretrainedConfig` of the model. The default values indicated are the
        ...
        Return:
            :class:`~adapter_transformers.file_utils.ModelOutput`.
    ...
    def _get_logits_warper(
        ...
        """
        This class returns a :obj:`~adapter_transformers.FlaxLogitsProcessorList` list object that contains all relevant
        :obj:`~adapter_transformers.FlaxLogitsWarper` instances used for multinomial sampling.
        """
    ...
    def _get_logits_processor(
        ...
        """
        This class returns a :obj:`~adapter_transformers.FlaxLogitsProcessorList` list object that contains all relevant
        :obj:`~adapter_transformers.FlaxLogitsProcessor` instances used to modify the scores of the language model head.
        """

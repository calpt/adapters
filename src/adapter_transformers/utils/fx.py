...
from adapter_transformers.file_utils import TORCH_FX_REQUIRED_VERSION, importlib_metadata, is_torch_fx_available
...
def symbolic_trace(
    ...
    Example::
        ...
        from adapter_transformers.modeling_fx_utils import symbolic_trace

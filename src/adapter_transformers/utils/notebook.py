...
class NotebookProgressBar:
    ...
    Args:
        ...
        leave (:obj:`bool`, `optional`, defaults to :obj:`True`):
            ...
            :meth:`~adapter_transformers.utils.notebook.NotebookProgressBar.close` method to make the bar disappear.
        parent (:class:`~adapter_transformers.notebook.NotebookTrainingTracker`, `optional`):
            A parent object (like :class:`~adapter_transformers.utils.notebook.NotebookTrainingTracker`) that spawns progress
...
class NotebookTrainingTracker(NotebookProgressBar):
    ...
    Args:
        ...
        column_names (:obj:`List[str]`, `optional`):
            ...
            :meth:`~adapter_transformers.utils.notebook.NotebookTrainingTracker.write_line` if not set).
    """
...
class NotebookProgressCallback(TrainerCallback):
    """
    A :class:`~adapter_transformers.TrainerCallback` that displays the progress of training or evaluation, optimized for

...
class FlaxLogitsProcessorList(list):
    """
    This class can be used to create a list of :class:`~adapter_transformers.FlaxLogitsProcessor` or
    :class:`~adapter_transformers.FlaxLogitsWarper` to subsequently process a :obj:`scores` input tensor. This class inherits
    from list and adds a specific `__call__` method to apply each :class:`~adapter_transformers.FlaxLogitsProcessor` or
    :class:`~adapter_transformers.FlaxLogitsWarper` to the inputs.
    """
...
class FlaxForcedBOSTokenLogitsProcessor(FlaxLogitsProcessor):
    r"""
    :class:`~adapter_transformers.FlaxLogitsProcessor` that enforces the specified token as the first generated token.
...
class FlaxForcedEOSTokenLogitsProcessor(FlaxLogitsProcessor):
    r"""
    :class:`~adapter_transformers.FlaxLogitsProcessor` that enforces the specified token as the last generated token when
...
class FlaxMinLengthLogitsProcessor(FlaxLogitsProcessor):
    r"""
    :class:`adapter_transformers.FlaxLogitsProcessor` enforcing a min-length by setting EOS probability to 0.

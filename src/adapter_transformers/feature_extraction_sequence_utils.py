...
class SequenceFeatureExtractor(FeatureExtractionMixin):
    ...
    def pad(
        ...
        Args:
            processed_features (:class:`~adapter_transformers.BatchFeature`, list of :class:`~adapter_transformers.BatchFeature`, :obj:`Dict[str, List[float]]`, :obj:`Dict[str, List[List[float]]` or :obj:`List[Dict[str, List[float]]]`):
                Processed inputs. Can represent one input (:class:`~adapter_transformers.BatchFeature` or :obj:`Dict[str,
                List[float]]`) or a batch of input values / vectors (list of :class:`~adapter_transformers.BatchFeature`,
        ...
        if self.model_input_names[0] not in processed_features:
            raise ValueError(
                "You should supply an instance of :class:`~adapter_transformers.BatchFeature` or list of :class:`~adapter_transformers.BatchFeature` to this method"

...
class TFTrainer:
    ...
    Args:
        model (:class:`~adapter_transformers.TFPreTrainedModel`):
            The model to train, evaluate or use for predictions.
        args (:class:`~adapter_transformers.TFTrainingArguments`):
        ...
        optimizers (:obj:`Tuple[tf.keras.optimizers.Optimizer, tf.keras.optimizers.schedules.LearningRateSchedule]`, `optional`):
            ...
            :class:`~adapter_transformers.AdamWeightDecay`. The scheduler will default to an instance of
            :class:`tf.keras.optimizers.schedules.PolynomialDecay` if :obj:`args.num_warmup_steps` is 0 else an
            instance of :class:`~adapter_transformers.WarmUp`.
    """
    ...
    def prediction_loop(
        ...
        """
        Prediction/evaluation loop, shared by :func:`~adapter_transformers.TFTrainer.evaluate` and
        :func:`~adapter_transformers.TFTrainer.predict`.

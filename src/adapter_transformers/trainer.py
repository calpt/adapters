...
class Trainer:
    ...
    Args:
        model (:class:`~adapter_transformers.PreTrainedModel` or :obj:`torch.nn.Module`, `optional`):
            The model to train, evaluate or use for predictions. If not provided, a ``model_init`` must be passed.

            .. note::

                :class:`~adapter_transformers.Trainer` is optimized to work with the :class:`~adapter_transformers.PreTrainedModel`
                provided by the library. You can still use your own models defined as :obj:`torch.nn.Module` as long as
                they work the same way as the 🤗 Transformers models.
        args (:class:`~adapter_transformers.TrainingArguments`, `optional`):
            The arguments to tweak for training. Will default to a basic instance of
            :class:`~adapter_transformers.TrainingArguments` with the ``output_dir`` set to a directory named `tmp_trainer` in
            the current directory if not provided.
        data_collator (:obj:`DataCollator`, `optional`):
            The function to use to form a batch from a list of elements of :obj:`train_dataset` or :obj:`eval_dataset`.
            Will default to :func:`~adapter_transformers.default_data_collator` if no ``tokenizer`` is provided, an instance of
            :func:`~adapter_transformers.DataCollatorWithPadding` otherwise.
        ...
        model_init (:obj:`Callable[[], PreTrainedModel]`, `optional`):
            ...
            :meth:`~adapter_transformers.Trainer.train` will start from a new instance of the model as given by this function.
        ...
        compute_metrics (:obj:`Callable[[EvalPrediction], Dict]`, `optional`):
            ...
            :class:`~adapter_transformers.EvalPrediction` and return a dictionary string to metric values.
        callbacks (List of :obj:`~adapter_transformers.TrainerCallback`, `optional`):
        ...
        optimizers (:obj:`Tuple[torch.optim.Optimizer, torch.optim.lr_scheduler.LambdaLR`, `optional`): A tuple
            ...
            :class:`~adapter_transformers.AdamW` on your model and a scheduler given by
            :func:`~adapter_transformers.get_linear_schedule_with_warmup` controlled by :obj:`args`.

    Important attributes:

        - **model** -- Always points to the core model. If using a adapter_transformers model, it will be a
          :class:`~adapter_transformers.PreTrainedModel` subclass.
    ...
    def _wrap_model(self, model, training=True):
        ...
        if self.sharded_ddp is not None:
            ...
            if self.args.ddp_find_unused_parameters is not None:
                ...
                # https://github.com/huggingface/adapter_transformers/pull/4659#issuecomment-643356021
        ...
        **kwargs,
        ...
        Args:
            resume_from_checkpoint (:obj:`str` or :obj:`bool`, `optional`):
                ...
                :class:`~adapter_transformers.Trainer`. If a :obj:`bool` and equals `True`, load the last checkpoint in
                `args.output_dir` as saved by a previous instance of :class:`~adapter_transformers.Trainer`. If present,
    ...
    def hyperparameter_search(
        ...
        **kwargs,
        ...
        .. warning::
            ...
            :class:`~adapter_transformers.Trainer`: we need to reinitialize the model at each new run. This is incompatible
            with the ``optimizers`` argument, so you need to subclass :class:`~adapter_transformers.Trainer` and override the
            method :meth:`~adapter_transformers.Trainer.create_optimizer_and_scheduler` for custom optimizer/scheduler.

        Args:
            hp_space (:obj:`Callable[["optuna.Trial"], Dict[str, float]]`, `optional`):
                A function that defines the hyperparameter search space. Will default to
                :func:`~adapter_transformers.trainer_utils.default_hp_space_optuna` or
                :func:`~adapter_transformers.trainer_utils.default_hp_space_ray` depending on your backend.
            compute_objective (:obj:`Callable[[Dict[str, float]], float]`, `optional`):
                A function computing the objective to minimize or maximize from the metrics returned by the
                :obj:`evaluate` method. Will default to :func:`~adapter_transformers.trainer_utils.default_compute_objective`.
            ...
            direction(:obj:`str`, `optional`, defaults to :obj:`"minimize"`):
                ...
                several metrics.
            backend(:obj:`str` or :class:`~adapter_transformers.training_utils.HPSearchBackend`, `optional`):
        ...
        Returns:
            :class:`adapter_transformers.trainer_utils.BestRun`: All the information about the best run.
        """
        if backend is None:
    ...
    def floating_point_ops(self, inputs: Dict[str, Union[torch.Tensor, Any]]):
        """
        For models that inherit from :class:`~adapter_transformers.PreTrainedModel`, uses that method to compute the number of
    ...
    def push_to_hub(self, commit_message: Optional[str] = "add model", **kwargs) -> str:
        ...
        Parameters:
            ...
            kwargs:
                Additional keyword arguments passed along to :meth:`~adapter_transformers.Trainer.create_model_card`.

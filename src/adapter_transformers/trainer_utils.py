...
class BestRun(NamedTuple):
    """
    The best run found by an hyperparameter search (see :class:`~adapter_transformers.Trainer.hyperparameter_search`).
...
def default_compute_objective(metrics: Dict[str, float]) -> float:
    ...
    metrics are provided to the :class:`~adapter_transformers.Trainer`, the sum of all metrics otherwise.
...
class TrainerMemoryTracker:
    ...
    To understand this class' intricacies please read the documentation of :meth:`~adapter_transformers.Trainer.log_metrics`.

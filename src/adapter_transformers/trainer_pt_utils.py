...
class IterableDatasetShard(IterableDataset):
    ...
    .. warning:
        ...
        :meth:`~adapter_transformers.trainer_pt_utils.IterableDatasetShard.set_epoch` method of this object. It will set the
    ...
    Args:
        ...
        seed (:obj:`int`, `optional`, defaults to 0):
            ...
            :meth:`~adapter_transformers.trainer_pt_utils.IterableDatasetShard.set_epoch`.
    """
...
def log_metrics(self, split, metrics):
    ...
    **Understanding the reports:**
    ...
    Note that this tracker doesn't account for memory allocations outside of :class:`~adapter_transformers.Trainer`'s
    ...
    This also means that if any other tool that is used along the :class:`~adapter_transformers.Trainer` calls
    ``torch.cuda.reset_peak_memory_stats``, the gpu peak memory stats could be invalid. And the
    :class:`~adapter_transformers.Trainer` will disrupt the normal behavior of any such tools that rely on calling
...
def save_metrics(self, split, metrics, combined=True):
    ...
    To understand the metrics please read the docstring of :meth:`~adapter_transformers.Trainer.log_metrics`. The only

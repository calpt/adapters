...
class RoFormerConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.RoFormerModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50000):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.RoFormerModel` or
            :class:`~adapter_transformers.TFRoFormerModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~adapter_transformers.RoFormerModel`
            or :class:`~adapter_transformers.TFRoFormerModel`.

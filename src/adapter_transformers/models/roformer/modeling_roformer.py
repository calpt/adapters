...
class RoFormerAttention(nn.Module):
    # Copied from adapter_transformers.models.bert.modeling_bert.BertAttention.__init__ with Bert->RoFormer
    def __init__(self, config):
        super().__init__()
...
class RoFormerLayer(nn.Module):
    # Copied from adapter_transformers.models.bert.modeling_bert.BertLayer.__init__ with Bert->RoFormer
    def __init__(self, config):
        super().__init__()
...
ROFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.RoFormerConfig`): Model configuration class with all the parameters of the model.
...
ROFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`{0}`):
            ...
            Indices can be obtained using :class:`adapter_transformers.RoFormerTokenizer`. See

...
class FlaxElectraForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.ElectraForPreTraining`.
...
ELECTRA_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.ElectraConfig`): Model configuration class with all the parameters of the model.
...
ELECTRA_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`numpy.ndarray` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.ElectraTokenizer`. See

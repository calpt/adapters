...
class ElectraConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.ElectraModel` or a
    :class:`~adapter_transformers.TFElectraModel`. It is used to instantiate a ELECTRA model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.ElectraModel` or
            :class:`~adapter_transformers.TFElectraModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~adapter_transformers.ElectraModel` or
            :class:`~adapter_transformers.TFElectraModel`.

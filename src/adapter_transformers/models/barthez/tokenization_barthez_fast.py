...
class BarthezTokenizerFast(PreTrainedTokenizerFast):
    """
    Adapted from :class:`~adapter_transformers.CamembertTokenizer` and :class:`~adapter_transformers.BartTokenizer`. Construct a "fast"
    BARThez tokenizer. Based on `SentencePiece <https://github.com/google/sentencepiece>`__.

    This tokenizer inherits from :class:`~adapter_transformers.PreTrainedTokenizerFast` which contains most of the main

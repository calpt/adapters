...
BART_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adapter_transformers.BartConfig`): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the
            configuration. Check out the :meth:`~adapter_transformers.TFPreTrainedModel.from_pretrained` method to load the
            model weights.
"""
...
BART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from adapter_transformers import BartTokenizer, TFBartForConditionalGeneration, BartConfig
...
BART_INPUTS_DOCSTRING = r"""
    Args:
        ...
        decoder_input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.BartTokenizer`. See
            :meth:`adapter_transformers.PreTrainedTokenizer.encode` and :meth:`adapter_transformers.PreTrainedTokenizer.__call__` for
            details.

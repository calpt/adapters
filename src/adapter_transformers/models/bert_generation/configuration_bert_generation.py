...
class BertGenerationConfig(PretrainedConfig):
    ...
    :class:`~adapter_transformers.BertGenerationPreTrainedModel`. It is used to instantiate a BertGeneration model according to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50358):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.BertGeneration`.

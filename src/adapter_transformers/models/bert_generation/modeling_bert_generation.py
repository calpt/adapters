...
BERT_GENERATION_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.BertGenerationConfig`): Model configuration class with all the parameters of the model.
...
BERT_GENERATION_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.BertGenerationTokenizer`. See
...
class BertGenerationEncoder(BertGenerationPreTrainedModel):
    ...
    :class:`~adapter_transformers.EncoderDecoderModel` class as described in `Leveraging Pre-trained Checkpoints for Sequence

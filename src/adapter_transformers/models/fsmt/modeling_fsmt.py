...
# - beam search: stops as soon as num_beams == len(hypos) (whereas adapter_transformers
#   is not satisfied there and will continue searching until the next cycles
#   aren't promising something better), comparing BLEU scores - the adapter_transformers
...
FSMT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.FSMTConfig`): Model configuration class with all the parameters of the model.
...
FSMT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            IIndices can be obtained using :class:`~adapter_transformers.FSTMTokenizer`. See
        ...
        decoder_input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.FSMTTokenizer`. See
            :meth:`adapter_transformers.PreTrainedTokenizer.encode` and :meth:`adapter_transformers.PreTrainedTokenizer.__call__` for
            details.

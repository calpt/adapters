...
class FunnelForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.FunnelForPreTraining`.
...
FUNNEL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.FunnelConfig`): Model configuration class with all the parameters of the model.

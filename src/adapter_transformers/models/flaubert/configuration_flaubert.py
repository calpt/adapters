...
class FlaubertConfig(XLMConfig):
    """
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.FlaubertModel` or a
    :class:`~adapter_transformers.TFFlaubertModel`. It is used to instantiate a FlauBERT model according to the specified
    ...
    Args:
        ...
        vocab_size (:obj:`int`, `optional`, defaults to 30145):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.FlaubertModel` or
            :class:`~adapter_transformers.TFFlaubertModel`.
        ...
        use_lang_emb (:obj:`bool`, `optional`, defaults to :obj:`True`)
            ...
            models page <http://huggingface.co/adapter_transformers/multilingual.html#xlm-language-embeddings>`__ for

...
# Copied from adapter_transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2FeatureExtractor with Wav2Vec2->Hubert
...
HUBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.HubertConfig`): Model configuration class with all the parameters of the model.
...
class HubertForCTC(HubertPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> import torch
            >>> from adapter_transformers import Wav2Vec2Processor, HubertForCTC
            >>> from datasets import load_dataset
            >>> import soundfile as sf

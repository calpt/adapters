...
class HubertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.HubertModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 32):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.HubertModel`. Vocabulary size of the model.
            Defines the different tokens that can be represented by the `inputs_ids` passed to the forward method of
            :class:`~adapter_transformers.HubertModel`.
        ...
        ctc_loss_reduction (:obj:`str`, `optional`, defaults to :obj:`"sum"`):
            ...
            instance of :class:`~adapter_transformers.HubertForCTC`.

...
TRANSFO_XL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.TransfoXLConfig`): Model configuration class with all the parameters of the model.
...
TRANSFO_XL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.TransfoXLTokenizer`. See
...
class TransfoXLLMHeadModel(TransfoXLPreTrainedModel):
    def __init__(self, config):
        ...
        ), "Sampling from the softmax is not implemented yet. Please look at issue: #3310: https://github.com/huggingface/adapter_transformers/issues/3310"
...
@add_start_docstrings(
    ...
    :class:`~adapter_transformers.TransfoXLForSequenceClassification` uses the last token in order to do the classification, as

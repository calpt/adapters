...
class TransfoXLConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.TransfoXLModel` or a
    :class:`~adapter_transformers.TFTransfoXLModel`. It is used to instantiate a Transformer-XL model according to the
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 267735):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.TransfoXLModel` or
            :class:`~adapter_transformers.TFTransfoXLModel`.

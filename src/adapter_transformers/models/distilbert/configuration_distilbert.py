...
class DistilBertConfig(ModelConfigAdaptersMixin, PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.DistilBertModel` or a
    :class:`~adapter_transformers.TFDistilBertModel`. It is used to instantiate a DistilBERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.DistilBertModel` or
            :class:`~adapter_transformers.TFDistilBertModel`.
        ...
        qa_dropout (:obj:`float`, `optional`, defaults to 0.1):
            ...
            :class:`~adapter_transformers.DistilBertForQuestionAnswering`.
        seq_classif_dropout (:obj:`float`, `optional`, defaults to 0.2):
            The dropout probabilities used in the sequence classification and the multiple choice model
            :class:`~adapter_transformers.DistilBertForSequenceClassification`.

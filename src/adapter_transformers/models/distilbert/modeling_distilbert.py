...
DISTILBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.DistilBertConfig`): Model configuration class with all the parameters of the model.
...
DISTILBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.DistilBertTokenizer`. See

...
class XLNetConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.XLNetModel` or a
    :class:`~adapter_transformers.TFXLNetModel`. It is used to instantiate a XLNet model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 32000):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.XLNetModel` or
            :class:`~adapter_transformers.TFXLNetModel`.
        ...
        mem_len (:obj:`int` or :obj:`None`, `optional`):
            ...
            <https://huggingface.co/adapter_transformers/quickstart.html#using-the-past>`__ for more information.

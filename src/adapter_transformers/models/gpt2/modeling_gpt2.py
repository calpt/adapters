...
GPT2_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.GPT2Config`): Model configuration class with all the parameters of the model.
...
GPT2_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, input_ids_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.GPT2Tokenizer`. See
...
@add_start_docstrings(
    ...
    :class:`~adapter_transformers.GPT2ForSequenceClassification` uses the last token in order to do the classification, as

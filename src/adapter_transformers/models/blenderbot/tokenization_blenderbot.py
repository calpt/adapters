...
class BlenderbotTokenizer(RobertaTokenizer):
    ...
    :class:`~adapter_transformers.Blenderbot` is nearly identical to :class:`~adapter_transformers.RobertaTokenizer` and runs
    ...
    Refer to superclass :class:`~adapter_transformers.RobertaTokenizer` for usage examples and documentation concerning
    parameters.
    """

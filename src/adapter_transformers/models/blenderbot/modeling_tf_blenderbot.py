...
BLENDERBOT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adapter_transformers.BlenderbotConfig`): Model configuration class with all the parameters of the model.
...
BLENDERBOT_GENERATION_EXAMPLE = r"""
    Conversation example::
        ...
        >>> from adapter_transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration

...
class VisualBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.VisualBertModel`. It is used
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.VisualBertModel`. Vocabulary size of the
            model. Defines the different tokens that can be represented by the ``inputs_ids`` passed to the forward
            method of :class:`~adapter_transformers.VisualBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            ...
            :class:`~adapter_transformers.VisualBertModel`.
        ...
        bypass_transformer (:obj:`bool`, `optional`, defaults to :obj:`False`):
            ...
            the model directly concatenates the visual embeddings from :class:`~adapter_transformers.VisualBertEmbeddings` with
            text output from adapter_transformers, and then pass it to a self-attention layer.

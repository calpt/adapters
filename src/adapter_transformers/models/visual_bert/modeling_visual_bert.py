...
class VisualBertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.VisualBertForPreTraining`.
...
VISUAL_BERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.VisualBertConfig`): Model configuration class with all the parameters of the model.

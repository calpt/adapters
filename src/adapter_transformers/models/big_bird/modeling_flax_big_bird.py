...
class FlaxBigBirdForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.BigBirdForPreTraining`.
...
BIG_BIRD_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.BigBirdConfig`): Model configuration class with all the parameters of the model.
...
BIG_BIRD_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`numpy.ndarray` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.BigBirdTokenizer`. See
            :meth:`adapter_transformers.PreTrainedTokenizer.encode` and :func:`adapter_transformers.PreTrainedTokenizer.__call__` for
            details.
...
class FlaxBigBirdAttention(nn.Module):
    ...
    # Copied from adapter_transformers.models.bert.modeling_flax_bert.FlaxBertAttention.__call__ with Bert->BigBird

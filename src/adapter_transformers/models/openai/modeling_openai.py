...
OPENAI_GPT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.OpenAIGPTConfig`): Model configuration class with all the parameters of the model.
...
OPENAI_GPT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.OpenAIGPTTokenizer`. See
...
@add_start_docstrings(
    ...
    :class:`~adapter_transformers.OpenAIGPTForSequenceClassification` uses the last token in order to do the classification, as

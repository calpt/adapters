...
class TapasConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.TapasModel`. It is used to
    ...
    architecture. Configuration objects inherit from :class:`~adapter_transformers.PreTrainedConfig` and can be used to control
    the model outputs. Read the documentation from :class:`~adapter_transformers.PretrainedConfig` for more information.
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.TapasModel`.
        ...
        type_vocab_sizes (:obj:`List[int]`, `optional`, defaults to :obj:`[3, 256, 256, 2, 256, 256, 10]`):
            The vocabulary sizes of the :obj:`token_type_ids` passed when calling :class:`~adapter_transformers.TapasModel`.

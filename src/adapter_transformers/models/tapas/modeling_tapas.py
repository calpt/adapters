...
class TableQuestionAnsweringOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.TapasForQuestionAnswering`.
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertAttention with Bert->Tapas
...
# Copied from adapter_transformers.models.bert.modeling_bert.BertLayer with Bert->Tapas
...
TAPAS_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.TapasConfig`): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the
            configuration. Check out the :meth:`~adapter_transformers.PreTrainedModel.from_pretrained` method to load the model
            weights.
"""
...
TAPAS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            :class:`~adapter_transformers.TapasTokenizer`. See :meth:`adapter_transformers.PreTrainedTokenizer.encode` and
            :meth:`adapter_transformers.PreTrainedTokenizer.__call__` for details.
        ...
        token_type_ids (:obj:`torch.LongTensor` of shape :obj:`({0}, 7)`, `optional`):
            ...
            :class:`~adapter_transformers.TapasTokenizer`. See this class for more info.

            `What are token type IDs? <../glossary.html#token-type-ids>`_
        position_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`, `optional`):
            Indices of positions of each input sequence tokens in the position embeddings. If
            ``reset_position_index_per_cell`` of :class:`~adapter_transformers.TapasConfig` is set to ``True``, relative
...
class TapasModel(TapasPreTrainedModel):
    """
    This class is a small change compared to :class:`~adapter_transformers.BertModel`, taking into account the additional token
    type ids.
...
class TapasForQuestionAnswering(TapasPreTrainedModel):
    ...
    def forward(
        ...
        labels (:obj:`torch.LongTensor` of shape :obj:`(batch_size, seq_length)`, `optional`):
            ...
            answer appearing in the table. Can be obtained using :class:`~adapter_transformers.TapasTokenizer`.
        ...
        numeric_values (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, seq_length)`, `optional`):
            ...
            :class:`~adapter_transformers.TapasTokenizer`. Only required in case of weak supervision for aggregation (WTQ) to
            calculate the regression loss.
        numeric_values_scale (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, seq_length)`, `optional`):
            Scale of the numeric values of every token. Can be obtained using :class:`~adapter_transformers.TapasTokenizer`.
...
def _calculate_expected_result(
    ...
    Args:
        ...
        logits_aggregation (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, num_aggregation_labels)`):
            Logits per aggregation operation.
        config (:class:`~adapter_transformers.TapasConfig`):

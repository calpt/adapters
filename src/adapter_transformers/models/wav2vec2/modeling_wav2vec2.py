...
class Wav2Vec2BaseModelOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.Wav2Vec2BaseModelOutput`, with potential hidden states and attentions.
...
class Wav2Vec2ForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.Wav2Vec2ForPreTrainingOutput`, with potential hidden states and attentions.
...
WAV_2_VEC_2_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.Wav2Vec2Config`): Model configuration class with all the parameters of the model.
...
WAV_2_VEC_2_INPUTS_DOCSTRING = r"""
    Args:
        input_values (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            soundfile`). To prepare the array into `input_values`, the :class:`~adapter_transformers.Wav2Vec2Processor` should
            be used for padding and conversion into a tensor of type `torch.FloatTensor`. See
            :meth:`adapter_transformers.Wav2Vec2Processor.__call__` for details.
...
class Wav2Vec2Model(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adapter_transformers import Wav2Vec2Processor, Wav2Vec2Model
...
class Wav2Vec2ForCTC(Wav2Vec2PreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> import torch
            >>> from adapter_transformers import Wav2Vec2Processor, Wav2Vec2ForCTC
            >>> from datasets import load_dataset
            >>> import soundfile as sf

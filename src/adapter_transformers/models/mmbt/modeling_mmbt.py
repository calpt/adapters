...
MMBT_START_DOCSTRING = r"""
    MMBT model was proposed in `Supervised Multimodal Biadapter_transformers for Classifying Images and Text
    ...
    Parameters:
        config (:class:`~adapter_transformers.MMBTConfig`): Model configuration class with all the parameters of the model.
...
MMBT_INPUTS_DOCSTRING = r"""
    Args:
        ...
        input_ids (``torch.LongTensor`` of shape ``(batch_size, sequence_length)``):
            ...
            :class:`~adapter_transformers.BertTokenizer`. See :meth:`adapter_transformers.PreTrainedTokenizer.encode` and

...
# Based adapter_transformers.models.bert.modeling_bert.BertSelfOutput. Moved LayerNorm to MegatronBertAttention below.
...
# Based adapter_transformers.models.bert.modeling_bert.BertAttention. Added LayerNorm.
...
# Based on adapter_transformers.models.bert.modeling_bert.BertOutput. Moved LayerNorm to MegatronBertLayer below.
...
# Based on adapter_transformers.models.bert.modeling_bert.BertLayer. Added LayerNorm.
...
class MegatronBertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.MegatronBertForPreTraining`.
...
MEGATRON_BERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.MegatronBertConfig`): Model configuration class with all the parameters of the model.

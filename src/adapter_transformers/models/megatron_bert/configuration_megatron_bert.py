...
class MegatronBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.MegatronBertModel`. It is
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 29056):
            ...
            by the :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.MegatronBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            ...
            :class:`~adapter_transformers.MegatronBertModel`.

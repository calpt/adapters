...
class DPRContextEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~adapter_transformers.DPRContextEncoderTokenizerFast` is identical to :class:`~adapter_transformers.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~adapter_transformers.BertTokenizerFast` for usage examples and documentation concerning
    parameters.
    """
...
class DPRQuestionEncoderTokenizerFast(BertTokenizerFast):
    ...
    :class:`~adapter_transformers.DPRQuestionEncoderTokenizerFast` is identical to :class:`~adapter_transformers.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece.
...
class DPRReaderTokenizerFast(CustomDPRReaderTokenizerMixin, BertTokenizerFast):
    ...
    :class:`~adapter_transformers.DPRReaderTokenizerFast` is almost identical to :class:`~adapter_transformers.BertTokenizerFast` and
    runs end-to-end tokenization: punctuation splitting and wordpiece. The difference is that is has three inputs
    strings: question, titles and texts that are combined to be fed to the :class:`~adapter_transformers.DPRReader` model.

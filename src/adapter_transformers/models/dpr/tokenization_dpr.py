...
class DPRContextEncoderTokenizer(BertTokenizer):
    ...
    :class:`~adapter_transformers.DPRContextEncoderTokenizer` is identical to :class:`~adapter_transformers.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece.

    Refer to superclass :class:`~adapter_transformers.BertTokenizer` for usage examples and documentation concerning
    parameters.
    """
...
class DPRQuestionEncoderTokenizer(BertTokenizer):
    ...
    :class:`~adapter_transformers.DPRQuestionEncoderTokenizer` is identical to :class:`~adapter_transformers.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece.
...
class DPRReaderTokenizer(CustomDPRReaderTokenizerMixin, BertTokenizer):
    ...
    :class:`~adapter_transformers.DPRReaderTokenizer` is almost identical to :class:`~adapter_transformers.BertTokenizer` and runs
    end-to-end tokenization: punctuation splitting and wordpiece. The difference is that is has three inputs strings:
    question, titles and texts that are combined to be fed to the :class:`~adapter_transformers.DPRReader` model.

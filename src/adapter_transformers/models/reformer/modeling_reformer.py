...
class ReformerModelOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.ReformerModel`.
...
class ReformerModelWithLMHeadOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.ReformerModelWithLMHead`.
...
REFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.ReformerConfig`): Model configuration class with all the parameters of the model.
...
REFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.ReformerTokenizer`. See
        ...
        num_hashes (:obj:`int`, `optional`):
            ...
            For more information, see :obj:`num_hashes` in :class:`~adapter_transformers.ReformerConfig`.

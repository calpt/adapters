...
CONVBERT_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adapter_transformers.ConvBertConfig`): Model configuration class with all the parameters of the model.
...
CONVBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.ConvBertTokenizer`. See

...
CLIP_START_DOCSTRING = r"""
    ...
    This model inherits from :class:`~adapter_transformers.FlaxPreTrainedModel`. Check the superclass documentation for the
    ...
    Parameters:
        config (:class:`~adapter_transformers.CLIPConfig`): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the
            configuration. Check out the :meth:`~adapter_transformers.FlaxPreTrainedModel.from_pretrained` method to load the
            model weights.
"""
...
CLIP_TEXT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`numpy.ndarray` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.CLIPTokenizer`. See
...
CLIP_VISION_INPUTS_DOCSTRING = r"""
    Args:
        pixel_values (:obj:`numpy.ndarray` of shape :obj:`(batch_size, num_channels, height, width)`):
            ...
            :class:`~adapter_transformers.CLIPFeatureExtractor`. See :meth:`adapter_transformers.CLIPFeatureExtractor.__call__` for
            details.
        output_attentions (:obj:`bool`, `optional`):
            Whether or not to return the attentions tensors of all attention layers. See ``attentions`` under returned
            tensors for more detail.
...
class FlaxCLIPOutput(ModelOutput):
    ...
    Args:
        ...
        text_embeds(:obj:`jax_xla.DeviceArray` of shape :obj:`(batch_size, output_dim`):
            ...
            :class:`~adapter_transformers.FlaxCLIPTextModel`.
        image_embeds(:obj:`jax_xla.DeviceArray` of shape :obj:`(batch_size, output_dim`):
            The image embeddings obtained by applying the projection layer to the pooled output of
            :class:`~adapter_transformers.FlaxCLIPVisionModel`.
        text_model_output(:obj:`FlaxBaseModelOutputWithPooling`):
            The output of the :class:`~adapter_transformers.FlaxCLIPTextModel`.
        vision_model_output(:obj:`FlaxBaseModelOutputWithPooling`):
            The output of the :class:`~adapter_transformers.FlaxCLIPVisionModel`.
    """
    ...
    def get_text_features(
        ...
        Args:
            input_ids (:obj:`numpy.ndarray` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~adapter_transformers.CLIPTokenizer`. See
                :meth:`adapter_transformers.PreTrainedTokenizer.encode` and :meth:`adapter_transformers.PreTrainedTokenizer.__call__`
                for details.
        ...
        Returns:
            ...
            obtained by applying the projection layer to the pooled output of :class:`~adapter_transformers.FlaxCLIPTextModel`.
        """
        if position_ids is None:
            position_ids = jnp.broadcast_to(jnp.arange(jnp.atleast_2d(input_ids).shape[-1]), input_ids.shape)
    ...
    def get_image_features(self, pixel_values, dropout_rng: jax.random.PRNGKey = None, train=False):
        ...
        Args:
            pixel_values (:obj:`numpy.ndarray` of shape :obj:`(batch_size, num_channels, height, width)`):
                ...
                using :class:`~adapter_transformers.CLIPFeatureExtractor`. See
                :meth:`adapter_transformers.CLIPFeatureExtractor.__call__` for details.

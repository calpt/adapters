...
class CLIPTextConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.CLIPModel`. It is used to
    ...
    Configuration objects inherit from :class:`~adapter_transformers.PretrainedConfig` and can be used to control the model
    outputs. Read the documentation from :class:`~adapter_transformers.PretrainedConfig` for more information.


    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 49408):
            Vocabulary size of the CLIP text model. Defines the number of different tokens that can be represented by
            the :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.CLIPModel`.
...
class CLIPConfig(PretrainedConfig):
    r"""
    :class:`~adapter_transformers.CLIPConfig` is the configuration class to store the configuration of a
    :class:`~adapter_transformers.CLIPModel`. It is used to instantiate CLIP model according to the specified arguments,
    ...
    Args:
        text_config_dict (:obj:`dict`, `optional`):
            Dictionary of configuration options used to initialize :class:`~adapter_transformers.CLIPTextConfig`.
        vision_config_dict (:obj:`dict`, `optional`):
            Dictionary of configuration options used to initialize :class:`~adapter_transformers.CLIPVisionConfig`.
    ...
    def from_text_vision_configs(cls, text_config: CLIPTextConfig, vision_config: CLIPVisionConfig, **kwargs):
        r"""
        Instantiate a :class:`~adapter_transformers.CLIPConfig` (or a derived class) from clip text model configuration and
    ...
    def to_dict(self):
        ...
        :meth:`~adapter_transformers.PretrainedConfig.to_dict`.

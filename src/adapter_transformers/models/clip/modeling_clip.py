...
class CLIPOutput(ModelOutput):
    ...
    Args:
        ...
        text_embeds(:obj:`torch.FloatTensor` of shape :obj:`(batch_size, output_dim`):
            ...
            :class:`~adapter_transformers.CLIPTextModel`.
        image_embeds(:obj:`torch.FloatTensor` of shape :obj:`(batch_size, output_dim`):
            The image embeddings obtained by applying the projection layer to the pooled output of
            :class:`~adapter_transformers.CLIPVisionModel`.
        text_model_output(:obj:`BaseModelOutputWithPooling`):
            The output of the :class:`~adapter_transformers.CLIPTextModel`.
        vision_model_output(:obj:`BaseModelOutputWithPooling`):
            The output of the :class:`~adapter_transformers.CLIPVisionModel`.
    """
...
class CLIPEncoder(nn.Module):
    ...
    :class:`~adapter_transformers.CLIPEncoderLayer`.
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        Returns:
            ...
            obtained by applying the projection layer to the pooled output of :class:`~adapter_transformers.CLIPTextModel`.
        """
    ...
    def get_image_features(
        ...
        Returns:
            ...
            obtained by applying the projection layer to the pooled output of :class:`~adapter_transformers.CLIPVisionModel`.
        """

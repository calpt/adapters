...
class MT5Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.MT5Model` or a
    :class:`~adapter_transformers.TFMT5Model`. It is used to instantiate a mT5 model according to the specified arguments,
    ...
    Arguments:
        vocab_size (:obj:`int`, `optional`, defaults to 32128):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.T5Model` or :class:`~adapter_transformers.TFT5Model`.

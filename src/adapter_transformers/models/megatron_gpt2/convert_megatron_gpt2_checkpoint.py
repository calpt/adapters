...
def convert_megatron_checkpoint(args, input_state_dict, config):
    ...
    megatron_to_adapter_transformers = {
    ...
    for key, val in transformer.items():
        ...
        # Transpose the QKV matrix.
            ...
            # Megatron stores (3*D) x D but adapter_transformers-GPT2 expects D x 3*D.
        ...
        # Transpose the weights.
            ...
            out_name = megatron_to_adapter_transformers[op_name]
    ...
    # For LM head, adapter_transformers' wants the matrix to weight embeddings.

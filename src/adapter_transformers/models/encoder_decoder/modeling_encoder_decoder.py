...
ENCODER_DECODER_START_DOCSTRING = r"""
    ...
    :meth:`~adapter_transformers.AutoModel.from_pretrained` function and the decoder is loaded via
    :meth:`~adapter_transformers.AutoModelForCausalLM.from_pretrained` function. Cross-attention layers are automatically added
    ...
    Parameters:
        config (:class:`~adapter_transformers.T5Config`): Model configuration class with all the parameters of the model.
...
ENCODER_DECODER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.PreTrainedTokenizer`. See
        ...
        decoder_input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            :class:`~adapter_transformers.PreTrainedTokenizer`. See :meth:`adapter_transformers.PreTrainedTokenizer.encode` and
        ...
        return_dict (:obj:`bool`, `optional`):
            If set to ``True``, the model will return a :class:`~adapter_transformers.file_utils.Seq2SeqLMOutput` instead of a
            plain tuple.
...
class EncoderDecoderModel(PreTrainedModel):
    r"""
    :class:`~adapter_transformers.EncoderDecoder` is a generic model class that will be instantiated as a transformer
    architecture with one of the base model classes of the library as encoder and another one as decoder when created
    with the :meth`~adapter_transformers.AutoModel.from_pretrained` class method for the encoder and
    :meth`~adapter_transformers.AutoModelForCausalLM.from_pretrained` class method for the decoder.
    """

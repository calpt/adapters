...
class BertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.BertForPreTraining`.
...
BERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.BertConfig`): Model configuration class with all the parameters of the model.

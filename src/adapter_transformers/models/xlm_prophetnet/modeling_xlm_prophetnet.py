...
class XLMProphetNetEncoder(ProphetNetEncoder):
    r"""
    This class overrides :class:`~adapter_transformers.ProphetNetEncoder`. Please check the superclass for the appropriate
...
class XLMProphetNetDecoder(ProphetNetDecoder):
    r"""
    This class overrides :class:`~adapter_transformers.ProphetNetDecoder`. Please check the superclass for the appropriate
    documentation alongside usage examples.
...
class XLMProphetNetModel(ProphetNetModel):
    r"""
    This class overrides :class:`~adapter_transformers.ProphetNetModel`. Please check the superclass for the appropriate
    documentation alongside usage examples.
...
class XLMProphetNetForConditionalGeneration(ProphetNetForConditionalGeneration):
    r"""
    This class overrides :class:`~adapter_transformers.ProphetNetForConditionalGeneration`. Please check the superclass for the
...
class XLMProphetNetForCausalLM(ProphetNetForCausalLM):
    r"""
    This class overrides :class:`~adapter_transformers.ProphetNetForCausalLM`. Please check the superclass for the appropriate
    documentation alongside usage examples.

...
class LEDConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.LEDModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.LEDModel` or :class:`~adapter_transformers.TFLEDModel`.

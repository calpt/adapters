...
LED_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adapter_transformers.LEDConfig`): Model configuration class with all the parameters of the model.
...
LED_INPUTS_DOCSTRING = r"""
    Args:
        ...
        decoder_input_ids (:obj:`tf.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.LedTokenizer`. See
            :meth:`adapter_transformers.PreTrainedTokenizer.encode` and :meth:`adapter_transformers.PreTrainedTokenizer.__call__` for
            details.
    ...
    def call(
        ...
        **kwargs,
        ...
        Args:
            input_ids (:obj:`tf.Tensor` of shape :obj:`(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
                provide it. Indices can be obtained using :class:`~adapter_transformers.LEDTokenizer`. See
                :meth:`adapter_transformers.PreTrainedTokenizer.encode` and :meth:`adapter_transformers.PreTrainedTokenizer.__call__`

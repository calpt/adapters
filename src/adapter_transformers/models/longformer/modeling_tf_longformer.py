...
LONGFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.LongformerConfig`): Model configuration class with all the parameters of the model.
...
LONGFORMER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.LongformerTokenizer`. See
...
class TFLongformerModel(TFLongformerPreTrainedModel):
    ...
    This class copies code from :class:`~adapter_transformers.TFRobertaModel` and overwrites standard self-attention with

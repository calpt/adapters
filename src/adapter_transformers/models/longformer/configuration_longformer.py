...
class LongformerConfig(RobertaConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.LongformerModel` or a
    :class:`~adapter_transformers.TFLongformerModel`. It is used to instantiate a Longformer model according to the specified
    arguments, defining the model architecture.

    This is the configuration class to store the configuration of a :class:`~adapter_transformers.LongformerModel`. It is used
    ...
    The :class:`~adapter_transformers.LongformerConfig` class directly inherits :class:`~adapter_transformers.RobertaConfig`. It reuses

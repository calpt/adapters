...
LONGFORMER_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.LongformerConfig`): Model configuration class with all the parameters of the
...
class LongformerModel(LongformerPreTrainedModel):
    """
    This class copied code from :class:`~adapter_transformers.RobertaModel` and overwrote standard self-attention with

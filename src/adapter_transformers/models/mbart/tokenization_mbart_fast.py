...
class MBartTokenizerFast(XLMRobertaTokenizerFast):
    ...
    :class:`~adapter_transformers.MBartTokenizerFast` is a subclass of :class:`~adapter_transformers.XLMRobertaTokenizerFast`. Refer to
    superclass :class:`~adapter_transformers.XLMRobertaTokenizerFast` for usage examples and documentation concerning the

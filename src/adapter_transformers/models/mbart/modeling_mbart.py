...
MBART_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.MBartConfig`):
...
MBART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from adapter_transformers import MBartTokenizer, MBartForConditionalGeneration, MBartConfig
...
MBART_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.MBartTokenizer`. See

...
class MBartTokenizer(XLMRobertaTokenizer):
    ...
    :class:`~adapter_transformers.MBartTokenizer` is a subclass of :class:`~adapter_transformers.XLMRobertaTokenizer`. Refer to
    superclass :class:`~adapter_transformers.XLMRobertaTokenizer` for usage examples and documentation concerning the

...
class DetrConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.DetrModel`. It is used to
    ...
    Args:
        num_queries (:obj:`int`, `optional`, defaults to 100):
            ...
            :class:`~adapter_transformers.DetrModel` can detect in a single image. For COCO, we recommend 100 queries.

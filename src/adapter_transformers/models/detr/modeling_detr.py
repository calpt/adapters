...
class DetrObjectDetectionOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.DetrForObjectDetection`.
    ...
    Args:
        ...
        pred_boxes (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, num_queries, 4)`):
            ...
            possible padding). You can use :meth:`~adapter_transformers.DetrFeatureExtractor.post_process` to retrieve the
...
class DetrSegmentationOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.DetrForSegmentation`.
    ...
    Args:
        ...
        pred_masks (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, num_queries, height/4, width/4)`):
            ...
            :meth:`~adapter_transformers.DetrFeatureExtractor.post_process_segmentation` or
            :meth:`~adapter_transformers.DetrFeatureExtractor.post_process_panoptic` to evaluate instance and panoptic
...
DETR_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.DetrConfig`):
...
DETR_INPUTS_DOCSTRING = r"""
    Args:
        pixel_values (:obj:`torch.FloatTensor` of shape :obj:`(batch_size, num_channels, height, width)`):
            ...
            Pixel values can be obtained using :class:`~adapter_transformers.DetrFeatureExtractor`. See
            :meth:`adapter_transformers.DetrFeatureExtractor.__call__` for details.

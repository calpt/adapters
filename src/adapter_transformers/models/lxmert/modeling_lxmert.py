...
class LxmertForQuestionAnsweringOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.LxmertForQuestionAnswering`.
...
class LxmertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.LxmertForPreTraining`.
...
LXMERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.LxmertConfig`): Model configuration class with all the parameters of the model.
...
LXMERT_INPUTS_DOCSTRING = r"""
    ...
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.LxmertTokenizer`. See
        ...
        visual_feats: (:obj:`torch.FloatTensor` of shape :obj:՝(batch_size, num_visual_features, visual_feat_dim)՝):
            ...
            These are currently not provided by the adapter_transformers library.

...
class LxmertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.LxmertModel` or a
    :class:`~adapter_transformers.TFLxmertModel`. It is used to instantiate a LXMERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.LxmertModel` or
            :class:`~adapter_transformers.TFLxmertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the `token_type_ids` passed into :class:`~adapter_transformers.BertModel`.

...
BIGBIRD_PEGASUS_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.BigBirdPegasusConfig`):
...
BIGBIRD_PEGASUS_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> from adapter_transformers import PegasusTokenizer, BigBirdPegasusForConditionalGeneration, BigBirdPegasusConfig
...
BIGBIRD_PEGASUS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.PegasusTokenizer`. See
...
BIGBIRD_PEGASUS_STANDALONE_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.ProphetNetTokenizer`. See
            :meth:`adapter_transformers.PreTrainedTokenizer.encode` and :meth:`adapter_transformers.PreTrainedTokenizer.__call__` for
            details.
    ...
    def forward(
        ...
        Args:
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~adapter_transformers.BigBirdPegasusTokenizer`. See
                :meth:`adapter_transformers.PreTrainedTokenizer.encode` and :meth:`adapter_transformers.PreTrainedTokenizer.__call__`
                for details.
...
class BigBirdPegasusDecoderWrapper(BigBirdPegasusPreTrainedModel):
    ...
    used in combination with the :class:`~adapter_transformers.EncoderDecoderModel` framework.
    """
...
# Copied from adapter_transformers.models.pegasus.modeling_pegasus.PegasusForCausalLM with Pegasus->BigBirdPegasus, 'facebook/bart-large'->"google/bigbird-pegasus-large-arxiv"
class BigBirdPegasusForCausalLM(BigBirdPegasusPreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from adapter_transformers import BigBirdPegasusTokenizer, BigBirdPegasusForCausalLM

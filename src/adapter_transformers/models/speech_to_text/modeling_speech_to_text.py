...
SPEECH_TO_TEXT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.Speech2TextConfig`):
...
SPEECH_TO_TEXT_INPUTS_DOCSTRING = r"""
    Args:
        input_features (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length, feature_size)`):
            ...
            into :obj:`input_features`, the :class:`~adapter_transformers.Speech2TextTokenizer` should be used for extracting
            the fbank features, padding and conversion into a tensor of type :obj:`torch.FloatTensor`. See
            :meth:`~adapter_transformers.Speech2TextTokenizer.__call__`
        ...
        decoder_input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, target_sequence_length)`, `optional`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.SpeechToTextTokenizer`. See
    ...
    def forward(
        ...
        Args:
            input_features (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length, feature_size)`):
                ...
                array into :obj:`input_features`, the :class:`~adapter_transformers.Speech2TextTokenizer` should be used for
                extracting the fbank features, padding and conversion into a tensor of type :obj:`torch.FloatTensor`.
                See :meth:`~adapter_transformers.Speech2TextTokenizer.__call__`
            attention_mask (:obj:`torch.Tensor` of shape :obj:`(batch_size, sequence_length)`, `optional`):
    ...
    def forward(
        ...
        Args:
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`~adapter_transformers.Speech2TextTokenizer`. See

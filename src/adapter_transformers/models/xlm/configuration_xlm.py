...
class XLMConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.XLMModel` or a
    :class:`~adapter_transformers.TFXLMModel`. It is used to instantiate a XLM model according to the specified arguments,
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30145):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.XLMModel` or :class:`~adapter_transformers.TFXLMModel`.

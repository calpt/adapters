...
class TFXLMWithLMHeadModelOutput(ModelOutput):
    """
    Base class for :class:`~adapter_transformers.TFXLMWithLMHeadModel` outputs.
...
XLM_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.XLMConfig`): Model configuration class with all the parameters of the model.

...
class LukeTokenizer(RobertaTokenizer):
    ...
    This tokenizer inherits from :class:`~adapter_transformers.RobertaTokenizer` which contains most of the main methods. Users
    should refer to this superclass for more information regarding those methods. Compared to
    :class:`~adapter_transformers.RobertaTokenizer`, :class:`~adapter_transformers.LukeTokenizer` also creates entity sequences, namely
    ...
    def __init__(
        ...
        **kwargs
        ...
        # for more information about lstrip and rstrip, see https://github.com/huggingface/adapter_transformers/pull/2778
        entity_token_1 = (
        ...
        **kwargs
        ...
        if return_offsets_mapping:
            raise NotImplementedError(
                ...
                "https://github.com/huggingface/adapter_transformers/pull/2674"
            )

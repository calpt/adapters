...
class LukeConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.LukeModel`. It is used to
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.LukeModel`.
        entity_vocab_size (:obj:`int`, `optional`, defaults to 500000):
            ...
            by the :obj:`entity_ids` passed when calling :class:`~adapter_transformers.LukeModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~adapter_transformers.LukeModel`.

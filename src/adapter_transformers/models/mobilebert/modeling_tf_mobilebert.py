...
class TFMobileBertForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~adapter_transformers.TFMobileBertForPreTraining`.
...
MOBILEBERT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.MobileBertConfig`): Model configuration class with all the parameters of the model.
...
MOBILEBERT_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`Numpy array` or :obj:`tf.Tensor` of shape :obj:`({0})`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.MobileBertTokenizer`. See

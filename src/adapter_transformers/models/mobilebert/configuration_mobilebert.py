...
class MobileBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.MobileBertModel` or a
    :class:`~adapter_transformers.TFMobileBertModel`. It is used to instantiate a MobileBERT model according to the specified
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            ...
            the :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.MobileBertModel` or
            :class:`~adapter_transformers.TFMobileBertModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed when calling :class:`~adapter_transformers.MobileBertModel`
            or :class:`~adapter_transformers.TFMobileBertModel`.

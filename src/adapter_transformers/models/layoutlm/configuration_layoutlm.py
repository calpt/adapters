...
class LayoutLMConfig(BertConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.LayoutLMModel`. It is used to
    ...
    Configuration objects inherit from :class:`~adapter_transformers.BertConfig` and can be used to control the model outputs.
    Read the documentation from :class:`~adapter_transformers.BertConfig` for more information.


    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 30522):
            Vocabulary size of the LayoutLM model. Defines the different tokens that can be represented by the
            `inputs_ids` passed to the forward method of :class:`~adapter_transformers.LayoutLMModel`.
        ...
        type_vocab_size (:obj:`int`, `optional`, defaults to 2):
            The vocabulary size of the :obj:`token_type_ids` passed into :class:`~adapter_transformers.LayoutLMModel`.

...
class BlenderbotSmallConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~adapter_transformers.BlenderbotSmallModel`. It is
    ...
    Args:
        vocab_size (:obj:`int`, `optional`, defaults to 50265):
            ...
            represented by the :obj:`inputs_ids` passed when calling :class:`~adapter_transformers.BlenderbotSmallModel` or
            :class:`~adapter_transformers.TFBlenderbotSmallModel`.

...
BLENDERBOT_SMALL_START_DOCSTRING = r"""
    ...
    Args:
        config (:class:`~adapter_transformers.BlenderbotSmallConfig`): Model configuration class with all the parameters of the model.
...
BLENDERBOT_SMALL_GENERATION_EXAMPLE = r"""
    Conversation example::
        ...
        >>> from adapter_transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration

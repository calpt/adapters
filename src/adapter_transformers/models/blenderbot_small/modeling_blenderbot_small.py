...
BLENDERBOT_SMALL_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.BlenderbotSmallConfig`):
...
BLENDERBOT_SMALL_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.BlenderbotSmallTokenizer`. See
...
# Copied from adapter_transformers.models.bart.modeling_bart.BartForCausalLM with Bart->BlenderbotSmall

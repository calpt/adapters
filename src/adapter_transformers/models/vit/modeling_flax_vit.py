...
VIT_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~adapter_transformers.ViTConfig`): Model configuration class with all the parameters of the model.
...
VIT_INPUTS_DOCSTRING = r"""
    Args:
        pixel_values (:obj:`numpy.ndarray` of shape :obj:`(batch_size, num_channels, height, width)`):
            Pixel values. Pixel values can be obtained using :class:`~adapter_transformers.ViTFeatureExtractor`. See
            :meth:`adapter_transformers.ViTFeatureExtractor.__call__` for details.
...
FLAX_VISION_CLASSIF_DOCSTRING = """
    ...
    Example::
        ...
        >>> from adapter_transformers import FlaxViTFeatureExtractor, ViTForImageClassification
        >>> from PIL import Image
        >>> import jax
        >>> import requests

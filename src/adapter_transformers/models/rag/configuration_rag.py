...
RAG_CONFIG_DOC = r"""
    :class:`~adapter_transformers.RagConfig` stores the configuration of a `RagModel`. Configuration objects inherit from
    :class:`~adapter_transformers.PretrainedConfig` and can be used to control the model outputs. Read the documentation from
    :class:`~adapter_transformers.PretrainedConfig` for more information.
    ...
    Args:
        ...
        max_combined_length (:obj:`int`, `optional`, defaults to 300):
            Max length of contextualized input returned by :meth:`~adapter_transformers.RagRetriever.__call__`.
        retrieval_vector_size (:obj:`int`, `optional`, defaults to 768):
            Dimensionality of the document embeddings indexed by :class:`~adapter_transformers.RagRetriever`.
        ...
        passages_path: (:obj:`str`, `optional`):
            ...
            :class:`~adapter_transformers.models.rag.retrieval_rag.LegacyIndex`

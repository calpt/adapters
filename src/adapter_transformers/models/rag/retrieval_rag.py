...
class Index:
    """
    A base class for the Indices encapsulated by the :class:`~adapter_transformers.RagRetriever`.
    """
...
class RagRetriever:
    ...
    Args:
        ...
        question_encoder_tokenizer (:class:`~adapter_transformers.PreTrainedTokenizer`):
            The tokenizer that was used to tokenize the question. It is used to decode the question and then use the
            generator_tokenizer.
        generator_tokenizer (:class:`~adapter_transformers.PreTrainedTokenizer`):
            The tokenizer used for the generator part of the RagModel.
        index (:class:`~adapter_transformers.models.rag.retrieval_rag.Index`, optional, defaults to the one defined by the configuration):
    ...
    def __call__(
        ...
        Args:
            ...
            n_docs (:obj:`int`, `optional`):
                The number of docs retrieved per query.
            return_tensors (:obj:`str` or :class:`~adapter_transformers.file_utils.TensorType`, `optional`, defaults to "pt"):
        ...
        Returns: :class:`~adapter_transformers.BatchEncoding`: A :class:`~adapter_transformers.BatchEncoding` with the following
        fields:

...
class GenerationMixin:
    ...
    :class:`~adapter_transformers.PreTrainedModel`.
    """

    def prepare_inputs_for_generation(self, input_ids: torch.LongTensor, **kwargs) -> Dict[str, Any]:
        """
        Implement in subclasses of :class:`~adapter_transformers.PreTrainedModel` for custom behavior to prepare inputs in the
        generate method.
        """
    ...
    def adjust_logits_during_generation(self, logits: torch.FloatTensor, **kwargs) -> torch.FloatTensor:
        """
        Implement in subclasses of :class:`~adapter_transformers.PreTrainedModel` for custom behavior to adjust the logits in
        the generate method.
        """
        return logits
    ...
    def _get_logits_warper(
        ...
        """
        This class returns a :obj:`~adapter_transformers.LogitsProcessorList` list object that contains all relevant
        :obj:`~adapter_transformers.LogitsWarper` instances used for multinomial sampling.
        """
        ...
        # the following idea is largely copied from this PR: https://github.com/huggingface/adapter_transformers/pull/5420/files
    ...
    def _get_logits_processor(
        ...
        """
        This class returns a :obj:`~adapter_transformers.LogitsProcessorList` list object that contains all relevant
        :obj:`~adapter_transformers.LogitsProcessor` instances used to modify the scores of the language model head.
        """
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        attribute of the same name inside the :class:`~adapter_transformers.PretrainedConfig` of the model. The default values
        ...
        Parameters:
            ...
            return_dict_in_generate (:obj:`bool`, `optional`, defaults to `False`):
                Whether or not to return a :class:`~adapter_transformers.file_utils.ModelOutput` instead of a plain tuple.
        ...
        Return:
            :class:`~adapter_transformers.file_utils.ModelOutput` or :obj:`torch.LongTensor`: A
            :class:`~adapter_transformers.file_utils.ModelOutput` (if ``return_dict_in_generate=True`` or when
            ``config.return_dict_in_generate=True``) or a :obj:`torch.FloatTensor`.

                If the model is `not` an encoder-decoder model (``model.config.is_encoder_decoder=False``), the
                possible :class:`~adapter_transformers.file_utils.ModelOutput` types are:

                    - :class:`~adapter_transformers.generation_utils.GreedySearchDecoderOnlyOutput`,
                    - :class:`~adapter_transformers.generation_utils.SampleDecoderOnlyOutput`,
                    - :class:`~adapter_transformers.generation_utils.BeamSearchDecoderOnlyOutput`,
                    - :class:`~adapter_transformers.generation_utils.BeamSampleDecoderOnlyOutput`

                If the model is an encoder-decoder model (``model.config.is_encoder_decoder=True``), the possible
                :class:`~adapter_transformers.file_utils.ModelOutput` types are:

                    - :class:`~adapter_transformers.generation_utils.GreedySearchEncoderDecoderOutput`,
                    - :class:`~adapter_transformers.generation_utils.SampleEncoderDecoderOutput`,
                    - :class:`~adapter_transformers.generation_utils.BeamSearchEncoderDecoderOutput`,
                    - :class:`~adapter_transformers.generation_utils.BeamSampleEncoderDecoderOutput`
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            logits_processor (:obj:`LogitsProcessorList`, `optional`):
                An instance of :class:`~adapter_transformers.LogitsProcessorList`. List of instances of class derived from
                :class:`~adapter_transformers.LogitsProcessor` used to modify the prediction scores of the language modeling
                head applied at each generation step.
            stopping_criteria (:obj:`StoppingCriteriaList`, `optional`):
                An instance of :class:`~adapter_transformers.StoppingCriteriaList`. List of instances of class derived from
                :class:`~adapter_transformers.StoppingCriteria` used to tell if the generation loop should stop.
        ...
        Return:
            :class:`~adapter_transformers.generation_utils.GreedySearchDecoderOnlyOutput`,
            :class:`~adapter_transformers.generation_utils.GreedySearchEncoderDecoderOutput` or obj:`torch.LongTensor`: A
            :obj:`torch.LongTensor` containing the generated tokens (default behaviour) or a
            :class:`~adapter_transformers.generation_utils.GreedySearchDecoderOnlyOutput` if
            ``model.config.is_encoder_decoder=False`` and ``return_dict_in_generate=True`` or a
            :class:`~adapter_transformers.generation_utils.GreedySearchEncoderDecoderOutput` if
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            logits_warper (:obj:`LogitsProcessorList`, `optional`):
                An instance of :class:`~adapter_transformers.LogitsProcessorList`. List of instances of class derived from
                :class:`~adapter_transformers.LogitsWarper` used to warp the prediction score distribution of the language
        ...
        Return:
            :class:`~adapter_transformers.generation_utils.SampleDecoderOnlyOutput`,
            :class:`~adapter_transformers.generation_utils.SampleEncoderDecoderOutput` or obj:`torch.LongTensor`: A
            :obj:`torch.LongTensor` containing the generated tokens (default behaviour) or a
            :class:`~adapter_transformers.generation_utils.SampleDecoderOnlyOutput` if
            ``model.config.is_encoder_decoder=False`` and ``return_dict_in_generate=True`` or a
            :class:`~adapter_transformers.generation_utils.SampleEncoderDecoderOutput` if
            ``model.config.is_encoder_decoder=True``.
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            beam_scorer (:obj:`BeamScorer`):
                An derived instance of :class:`~adapter_transformers.BeamScorer` that defines how beam hypotheses are
                constructed, stored and sorted during generation. For more information, the documentation of
                :class:`~adapter_transformers.BeamScorer` should be read.
            logits_processor (:obj:`LogitsProcessorList`, `optional`):
                An instance of :class:`~adapter_transformers.LogitsProcessorList`. List of instances of class derived from
                :class:`~adapter_transformers.LogitsProcessor` used to modify the prediction scores of the language modeling
                head applied at each generation step.
        ...
        Return:
            :class:`~adapter_transformers.generation_utilsBeamSearchDecoderOnlyOutput`,
            :class:`~adapter_transformers.generation_utils.BeamSearchEncoderDecoderOutput` or obj:`torch.LongTensor`: A
            :obj:`torch.LongTensor` containing the generated tokens (default behaviour) or a
            :class:`~adapter_transformers.generation_utils.BeamSearchDecoderOnlyOutput` if
            ``model.config.is_encoder_decoder=False`` and ``return_dict_in_generate=True`` or a
            :class:`~adapter_transformers.generation_utils.BeamSearchEncoderDecoderOutput` if
            ``model.config.is_encoder_decoder=True``.
        ...
        **model_kwargs,
        ...
        Parameters:
            ...
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`, `optional`):
                ...
                :obj:`torch.LongTensor` of shape :obj:`(1,)`.
            beam_scorer (:obj:`BeamScorer`):
                A derived instance of :class:`~adapter_transformers.BeamScorer` that defines how beam hypotheses are
                constructed, stored and sorted during generation. For more information, the documentation of
                :class:`~adapter_transformers.BeamScorer` should be read.
            logits_processor (:obj:`LogitsProcessorList`, `optional`):
                An instance of :class:`~adapter_transformers.LogitsProcessorList`. List of instances of class derived from
        ...
        Return:
            :class:`~adapter_transformers.generation_utils.BeamSampleDecoderOnlyOutput`,
            :class:`~adapter_transformers.generation_utils.BeamSampleEncoderDecoderOutput` or obj:`torch.LongTensor`: A
            :obj:`torch.LongTensor` containing the generated tokens (default behaviour) or a
            :class:`~adapter_transformers.generation_utils.BeamSampleDecoderOnlyOutput` if
            ``model.config.is_encoder_decoder=False`` and ``return_dict_in_generate=True`` or a
            :class:`~adapter_transformers.generation_utils.BeamSampleEncoderDecoderOutput` if
            ``model.config.is_encoder_decoder=True``.

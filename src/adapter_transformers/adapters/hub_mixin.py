...
```
_Note: adapter-transformers is a fork of adapter_transformers that acts as a drop-in replacement with adapter support. [More](https://docs.adapterhub.ml/installation.html)_
    ...
    def push_adapter_to_hub(
        ...
        Args:
            ...
            use_auth_token (:obj:`bool` or :obj:`str`, `optional`):
                ...
                generated when running :obj:`adapter_transformers-cli login` (stored in :obj:`~/.huggingface`). Defaults to True.

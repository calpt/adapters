...
class OnnxConverterArgumentParser(ArgumentParser):
    """
    Wraps all the script arguments supported to export adapter_transformers models to ONNX IR
    """
        ...
        if args.quantize:
            ...
            if args.framework == "tf":
                print(
                    ...
                    "\t\thttps://github.com/microsoft/onnxruntime/tree/master/onnxruntime/python/tools/adapter_transformers\n"
                )

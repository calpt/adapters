...
class BatchFeature(UserDict):
    r"""
    Holds the output of the :meth:`~adapter_transformers.SequenceFeatureExtractor.pad` and feature extractor specific
    ``__call__`` methods.
    ...
    def to(self, device: Union[str, "torch.device"]) -> "BatchFeature":
        ...
        Returns:
            :class:`~adapter_transformers.BatchFeature`: The same instance after modification.
        """
...
class FeatureExtractionMixin:
    ...
    def from_pretrained(
        ...
        r"""
        Instantiate a type of :class:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin` from a feature
        extractor, *e.g.* a derived class of :class:`~adapter_transformers.SequenceFeatureExtractor`.
        ...
        Args:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`):
                ...
                - a path to a `directory` containing a feature extractor file saved using the
                  :func:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin.save_pretrained` method, e.g.,
                  ``./my_model_directory/``.
        ...
        Returns:
            A feature extractor of type :class:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin`.
    ...
    def save_pretrained(self, save_directory: Union[str, os.PathLike]):
        ...
        :func:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin.from_pretrained` class method.
    ...
    def get_feature_extractor_dict(
        ...
        feature extractor of type :class:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin` using
        ``from_dict``.
    ...
    def from_dict(cls, feature_extractor_dict: Dict[str, Any], **kwargs) -> PreTrainedFeatureExtractor:
        """
        Instantiates a type of :class:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin` from a Python
        ...
        Args:
            feature_extractor_dict (:obj:`Dict[str, Any]`):
                ...
                :func:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin.to_dict` method.
            kwargs (:obj:`Dict[str, Any]`):
                Additional parameters from which to initialize the feature extractor object.

        Returns:
            :class:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin`: The feature extractor object
    ...
    def from_json_file(cls, json_file: Union[str, os.PathLike]) -> PreTrainedFeatureExtractor:
        """
        Instantiates a feature extractor of type :class:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin`
        ...
        Returns:
            A feature extractor of type :class:`~adapter_transformers.feature_extraction_utils.FeatureExtractionMixin`: The

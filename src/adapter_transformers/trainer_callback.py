...
class TrainerState:
    """
    A class containing the :class:`~adapter_transformers.Trainer` inner state that will be saved along the model and optimizer
    when checkpointing and passed to the :class:`~adapter_transformers.TrainerCallback`.
...
class TrainerControl:
    """
    A class that handles the :class:`~adapter_transformers.Trainer` control flow. This class is used by the
    :class:`~adapter_transformers.TrainerCallback` to activate some switches in the training loop.
...
class TrainerCallback:
    ...
    Args:
        args (:class:`~adapter_transformers.TrainingArguments`):
            The training arguments used to instantiate the :class:`~adapter_transformers.Trainer`.
        state (:class:`~adapter_transformers.TrainerState`):
            The current state of the :class:`~adapter_transformers.Trainer`.
        control (:class:`~adapter_transformers.TrainerControl`):
            The object that is returned to the :class:`~adapter_transformers.Trainer` and can be used to make some decisions.
        model (:class:`~adapter_transformers.PreTrainedModel` or :obj:`torch.nn.Module`):
            The model being trained.
        tokenizer (:class:`~adapter_transformers.PreTrainedTokenizer`):
    ...
    def on_init_end(self, args: TrainingArguments, state: TrainerState, control: TrainerControl, **kwargs):
        """
        Event called at the end of the initialization of the :class:`~adapter_transformers.Trainer`.
        """
        pass
...
class DefaultFlowCallback(TrainerCallback):
    """
    A :class:`~adapter_transformers.TrainerCallback` that handles the default flow of the training loop for logs, evaluation
    and checkpoints.
    """
...
class ProgressCallback(TrainerCallback):
    """
    A :class:`~adapter_transformers.TrainerCallback` that displays the progress of training or evaluation.
    """
...
class PrinterCallback(TrainerCallback):
    """
    A bare :class:`~adapter_transformers.TrainerCallback` that just prints the logs.
    """
...
class EarlyStoppingCallback(TrainerCallback):
    """
    A :class:`~adapter_transformers.TrainerCallback` that handles early stopping.
    ...
    This callback depends on :class:`~adapter_transformers.TrainingArguments` argument `load_best_model_at_end` functionality
    to set best_metric in :class:`~adapter_transformers.TrainerState`.
    """

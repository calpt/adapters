...
PROCESS_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size * num_beams, sequence_length)`):
            ...
            Indices can be obtained using any class inheriting from :class:`~adapter_transformers.PreTrainedTokenizer`. See
...
class BeamScorer(ABC):
    """
    Abstract base class for all beam scorers that are used for :meth:`~adapter_transformers.PreTrainedModel.beam_search` and
    :meth:`~adapter_transformers.PreTrainedModel.beam_sample`.
    """
...
class BeamSearchScorer(BeamScorer):
    r"""
    :class:`adapter_transformers.BeamScorer` implementing standard beam search decoding.

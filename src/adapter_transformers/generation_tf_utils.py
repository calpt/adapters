...
class TFGenerationMixin:
    ...
    :class:`~adapter_transformers.TFPreTrainedModel`.
    """

    def prepare_inputs_for_generation(self, inputs, **kwargs):
        """
        Implement in subclasses of :class:`~adapter_transformers.TFPreTrainedModel` for custom behavior to prepare inputs in
        the generate method.
        """
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        Return:
            :class:`~adapter_transformers.file_utils.ModelOutput` or :obj:`tf.Tensor`: A
            ...
            ``config.return_dict_in_generate=True``) or a :obj:`tf.Tensor`.
                ...
                possible :class:`~adapter_transformers.file_utils.ModelOutput` types are:
                    ...
                    - :class:`~adapter_transformers.generation_utils.TFGreedySearchDecoderOnlyOutput`,
                    - :class:`~adapter_transformers.generation_utils.TFSampleDecoderOnlyOutput`,
                    - :class:`~adapter_transformers.generation_utils.TFBeamSearchDecoderOnlyOutput`,
                    - :class:`~adapter_transformers.generation_utils.TFBeamSampleDecoderOnlyOutput`

                If the model is an encoder-decoder model (``model.config.is_encoder_decoder=True``), the possible
                :class:`~adapter_transformers.file_utils.ModelOutput` types are:

                    - :class:`~adapter_transformers.generation_utils.TFGreedySearchEncoderDecoderOutput`,
                    - :class:`~adapter_transformers.generation_utils.TFSampleEncoderDecoderOutput`,
                    - :class:`~adapter_transformers.generation_utils.TFBeamSearchEncoderDecoderOutput`,
                    - :class:`~adapter_transformers.generation_utils.TFBeamSampleEncoderDecoderOutput`

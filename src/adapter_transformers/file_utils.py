...
if (
    ...
    logger.warning(
        ...
        "'~/.cache/torch/adapter_transformers' to '~/.cache/huggingface/adapter_transformers'. Since you don't seem to have overridden "
        "and '~/.cache/torch/adapter_transformers' is a directory that exists, we're moving it to "
        "'~/.cache/huggingface/adapter_transformers' to avoid redownloading models you have already in the cache. You should "
...
def add_start_docstrings_to_model_forward(*docstr):
    def docstring_decorator(fn):
        class_name = f":class:`~adapter_transformers.{fn.__qualname__.split('.')[0]}`"
...
PT_RETURN_INTRODUCTION = r"""
    Returns:
        ...
        various elements depending on the configuration (:class:`~adapter_transformers.{config_class}`) and inputs.
...
TF_RETURN_INTRODUCTION = r"""
    Returns:
        ...
        elements depending on the configuration (:class:`~adapter_transformers.{config_class}`) and inputs.
...
PT_TOKEN_CLASSIFICATION_SAMPLE = r"""
    Example::
        ...
        >>> from adapter_transformers import {tokenizer_class}, {model_class}
        >>> import torch
...
def get_cached_models(cache_dir: Union[str, Path] = None) -> List[Tuple]:
    ...
    Args:
        cache_dir (:obj:`Union[str, Path]`, `optional`):
            The cache directory to search for models within. Will default to the adapter_transformers cache if unset.
...
class ModelOutput(OrderedDict):
    ...
    .. warning::
        You can't unpack a :obj:`ModelOutput` directly. Use the :meth:`~adapter_transformers.file_utils.ModelOutput.to_tuple`
...
class PushToHubMixin:
    ...
    def push_to_hub(
        ...
        Parameters:
            ...
            use_auth_token (:obj:`bool` or :obj:`str`, `optional`):
                ...
                generated when running :obj:`adapter_transformers-cli login` (stored in :obj:`~/.huggingface`). Will default to
    ...
    def _get_repo_url_from_name(
        ...
        if isinstance(use_auth_token, str):
            ...
            if token is None:
                raise ValueError(
                    "You must login to the Hugging Face hub on this computer by typing `adapter_transformers-cli login` and "

...
class Conversation:
    ...
    :class:`~adapter_transformers.ConversationalPipeline`. The conversation contains a number of utility function to manage the
    addition of new user input and generated model responses. A conversation needs to contain an unprocessed user input
    before being passed to the :class:`~adapter_transformers.ConversationalPipeline`. This user input is either created when
    ...
    Arguments:
        text (:obj:`str`, `optional`):
            ...
            manually using the :meth:`~adapter_transformers.Conversation.add_user_input` method before the conversation can
            begin.
...
class ConversationalPipeline(Pipeline):
    ...
    This conversational pipeline can currently be loaded from :func:`~adapter_transformers.pipeline` using the following task
    ...
    def __call__(
        ...
        **generate_kwargs
        ...
        Args:
            conversations (a :class:`~adapter_transformers.Conversation` or a list of :class:`~adapter_transformers.Conversation`):
        ...
        Returns:
            :class:`~adapter_transformers.Conversation` or a list of :class:`~adapter_transformers.Conversation`: Conversation(s) with

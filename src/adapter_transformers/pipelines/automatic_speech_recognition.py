...
class AutomaticSpeechRecognitionPipeline(Pipeline):
    ...
    def __init__(self, feature_extractor: "SequenceFeatureExtractor", *args, **kwargs):
        """
        Arguments:
            feature_extractor (:obj:`~adapter_transformers.SequenceFeatureExtractor`):
            ...
            model (:obj:`~adapter_transformers.PreTrainedModel` or :obj:`~adapter_transformers.TFPreTrainedModel`):
                ...
                from :class:`~adapter_transformers.PreTrainedModel` for PyTorch and :class:`~adapter_transformers.TFPreTrainedModel`
                for TensorFlow.
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        Classify the sequence(s) given as inputs. See the :obj:`~adapter_transformers.AutomaticSpeechRecognitionPipeline`

...
class QuestionAnsweringArgumentHandler(ArgumentHandler):
    ...
    internal :class:`~adapter_transformers.SquadExample`.

    QuestionAnsweringArgumentHandler manages all the possible to create a :class:`~adapter_transformers.SquadExample` from the
...
class QuestionAnsweringPipeline(Pipeline):
    ...
    This question answering pipeline can currently be loaded from :func:`~adapter_transformers.pipeline` using the following
    ...
    def create_sample(
        ...
        """
        QuestionAnsweringPipeline leverages the :class:`~adapter_transformers.SquadExample` internally. This helper method
        encapsulate all the logic for converting question(s) and context(s) to :class:`~adapter_transformers.SquadExample`.
        ...
        Returns:
            One or a list of :class:`~adapter_transformers.SquadExample`: The corresponding :class:`~adapter_transformers.SquadExample`
    ...
    def __call__(self, *args, **kwargs):
        ...
        Args:
            args (:class:`~adapter_transformers.SquadExample` or a list of :class:`~adapter_transformers.SquadExample`):
                One or several :class:`~adapter_transformers.SquadExample` containing the question and context.
            X (:class:`~adapter_transformers.SquadExample` or a list of :class:`~adapter_transformers.SquadExample`, `optional`):
                One or several :class:`~adapter_transformers.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).
            data (:class:`~adapter_transformers.SquadExample` or a list of :class:`~adapter_transformers.SquadExample`, `optional`):
                One or several :class:`~adapter_transformers.SquadExample` containing the question and context (will be treated
                the same way as if passed as the first positional argument).

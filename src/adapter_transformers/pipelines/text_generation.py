...
class TextGenerationPipeline(Pipeline):
    ...
    This language generation pipeline can currently be loaded from :func:`~adapter_transformers.pipeline` using the following
        ...
        **generate_kwargs
        ...
        for prompt_text in text_inputs:
            ...
            with self.device_placement():
                ...
                ), "Batch generation is currently not supported. See https://github.com/huggingface/adapter_transformers/issues/3021 for more information."

...
def infer_framework_load_model(
    ...
    **model_kwargs
    ...
    Args:
        model (:obj:`str`, :class:`~adapter_transformers.PreTrainedModel` or :class:`~adapter_transformers.TFPreTrainedModel`):
            The model to infer the framework from. If :obj:`str`, a checkpoint name. The model to infer the framewrok
            from.
        config (:class:`~adapter_transformers.AutoConfig`):
...
class PipelineException(Exception):
    """
    Raised by a :class:`~adapter_transformers.Pipeline` when handling __call__.
...
class ArgumentHandler(ABC):
    """
    Base interface for handling arguments for each :class:`~adapter_transformers.pipelines.Pipeline`.
    """
...
class PipelineDataFormat:
    ...
    def save(self, data: Union[dict, List[dict]]):
        ...
        :class:`~adapter_transformers.pipelines.PipelineDataFormat`.
    ...
    def from_str(
        ...
        """
        Creates an instance of the right subclass of :class:`~adapter_transformers.pipelines.PipelineDataFormat` depending on
        :obj:`format`.
        ...
        Returns:
            :class:`~adapter_transformers.pipelines.PipelineDataFormat`: The proper data format.
        """
        if format == "json":
...
PIPELINE_INIT_ARGS = r"""
    Arguments:
        model (:obj:`~adapter_transformers.PreTrainedModel` or :obj:`~adapter_transformers.TFPreTrainedModel`):
            The model that will be used by the pipeline to make predictions. This needs to be a model inheriting from
            :class:`~adapter_transformers.PreTrainedModel` for PyTorch and :class:`~adapter_transformers.TFPreTrainedModel` for
            TensorFlow.
        tokenizer (:obj:`~adapter_transformers.PreTrainedTokenizer`):
            The tokenizer that will be used by the pipeline to encode data for the model. This object inherits from
            :class:`~adapter_transformers.PreTrainedTokenizer`.
        modelcard (:obj:`str` or :class:`~adapter_transformers.ModelCard`, `optional`):
        ...
        args_parser (:class:`~adapter_transformers.pipelines.ArgumentHandler`, `optional`):
...
class Pipeline(_ScikitCompat):
    ...
    Some pipeline, like for instance :class:`~adapter_transformers.FeatureExtractionPipeline` (:obj:`'feature-extraction'` )
    ...
    def transform(self, X):
        """
        Scikit / Keras interface to adapter_transformers' pipelines. This method will forward to __call__().
        """
        return self(X=X)

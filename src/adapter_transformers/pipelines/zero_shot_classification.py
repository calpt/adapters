...
class ZeroShotClassificationPipeline(Pipeline):
    ...
    config's :attr:`~adapter_transformers.PretrainedConfig.label2id`.

    This NLI pipeline can currently be loaded from :func:`~adapter_transformers.pipeline` using the following task identifier:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        Classify the sequence(s) given as inputs. See the :obj:`~adapter_transformers.ZeroShotClassificationPipeline`

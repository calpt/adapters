...
def pipeline(
    ...
    **kwargs
    ...
    """
    Utility factory method to build a :class:`~adapter_transformers.Pipeline`.
    ...
    Args:
        task (:obj:`str`):
            ...
            - :obj:`"feature-extraction"`: will return a :class:`~adapter_transformers.FeatureExtractionPipeline`.
            - :obj:`"text-classification"`: will return a :class:`~adapter_transformers.TextClassificationPipeline`.
            - :obj:`"sentiment-analysis"`: (alias of :obj:`"text-classification") will return a
              :class:`~adapter_transformers.TextClassificationPipeline`.
            - :obj:`"token-classification"`: will return a :class:`~adapter_transformers.TokenClassificationPipeline`.
            - :obj:`"ner"` (alias of :obj:`"token-classification"): will return a
              :class:`~adapter_transformers.TokenClassificationPipeline`.
            - :obj:`"question-answering"`: will return a :class:`~adapter_transformers.QuestionAnsweringPipeline`.
            - :obj:`"fill-mask"`: will return a :class:`~adapter_transformers.FillMaskPipeline`.
            - :obj:`"summarization"`: will return a :class:`~adapter_transformers.SummarizationPipeline`.
            - :obj:`"translation_xx_to_yy"`: will return a :class:`~adapter_transformers.TranslationPipeline`.
            - :obj:`"text2text-generation"`: will return a :class:`~adapter_transformers.Text2TextGenerationPipeline`.
            - :obj:`"text-generation"`: will return a :class:`~adapter_transformers.TextGenerationPipeline`.
            - :obj:`"zero-shot-classification:`: will return a :class:`~adapter_transformers.ZeroShotClassificationPipeline`.
            - :obj:`"conversational"`: will return a :class:`~adapter_transformers.ConversationalPipeline`.
        model (:obj:`str` or :obj:`~adapter_transformers.PreTrainedModel` or :obj:`~adapter_transformers.TFPreTrainedModel`, `optional`):
            The model that will be used by the pipeline to make predictions. This can be a model identifier or an
            actual instance of a pretrained model inheriting from :class:`~adapter_transformers.PreTrainedModel` (for PyTorch)
            or :class:`~adapter_transformers.TFPreTrainedModel` (for TensorFlow).

            If not provided, the default for the :obj:`task` will be loaded.
        config (:obj:`str` or :obj:`~adapter_transformers.PretrainedConfig`, `optional`):
            The configuration that will be used by the pipeline to instantiate the model. This can be a model
            identifier or an actual pretrained model configuration inheriting from
            :class:`~adapter_transformers.PretrainedConfig`.
        ...
        tokenizer (:obj:`str` or :obj:`~adapter_transformers.PreTrainedTokenizer`, `optional`):
            The tokenizer that will be used by the pipeline to encode data for the model. This can be a model
            identifier or an actual pretrained tokenizer inheriting from :class:`~adapter_transformers.PreTrainedTokenizer`.
        ...
        feature_extractor (:obj:`str` or :obj:`~adapter_transformers.PreTrainedFeatureExtractor`, `optional`):
            The feature extractor that will be used by the pipeline to encode data for the model. This can be a model
            identifier or an actual pretrained feature extractor inheriting from
            :class:`~adapter_transformers.PreTrainedFeatureExtractor`.
        ...
        use_fast (:obj:`bool`, `optional`, defaults to :obj:`True`):
            Whether or not to use a Fast tokenizer if possible (a :class:`~adapter_transformers.PreTrainedTokenizerFast`).
    ...
    Returns:
        :class:`~adapter_transformers.Pipeline`: A suitable pipeline for the task.

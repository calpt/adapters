...
class DataCollatorForSeq2Seq:
    ...
    Args:
        tokenizer (:class:`~adapter_transformers.PreTrainedTokenizer` or :class:`~adapter_transformers.PreTrainedTokenizerFast`):
            The tokenizer used for encoding the data.
        model (:class:`~adapter_transformers.PreTrainedModel`):
...
class DataCollatorForLanguageModeling:
    ...
    .. note::
        ...
        :class:`~adapter_transformers.PreTrainedTokenizer` or a :class:`~adapter_transformers.PreTrainedTokenizerFast` with the

...
class PreTrainedTokenizerFast(PreTrainedTokenizerBase):
    ...
    def set_truncation_and_padding(
        ...
        Args:
            padding_strategy (:class:`~adapter_transformers.file_utils.PaddingStrategy`):
                The kind of padding that will be applied to the input
            truncation_strategy (:class:`~adapter_transformers.tokenization_utils_base.TruncationStrategy`):

...
class HfDeepSpeedConfig:
    ...
    :class:`~adapter_transformers.Trainer` uses the ``HfTrainerDeepSpeedConfig`` subclass instead. That subclass has logic to
    sync the configuration with values of :class:`~adapter_transformers.TrainingArguments` by replacing special placeholder

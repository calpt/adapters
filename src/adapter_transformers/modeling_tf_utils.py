...
class TFPreTrainedModel(tf.keras.Model, TFModelUtilsMixin, TFGenerationMixin, PushToHubMixin):
    ...
    :class:`~adapter_transformers.TFPreTrainedModel` takes care of storing the configuration of the models and handles methods
    ...
    def serving_output(output):
        ...
        Args:
            output (:obj:`~adapter_transformers.TFBaseModelOutput`):
    ...
    def save_pretrained(self, save_directory, saved_model=False, version=1, push_to_hub=False, **kwargs):
        ...
        :func:`~adapter_transformers.TFPreTrainedModel.from_pretrained` class method.
        ...
        Parameters:
            ...
            config (:obj:`Union[PretrainedConfig, str]`, `optional`):
                Can be either:
                    ...
                    - a string valid as input to :func:`~adapter_transformers.PretrainedConfig.from_pretrained`.
                ...
                be automatically loaded when:
                    ...
                    - The model is a model provided by the library (loaded with the `model id` string of a pretrained
                      model).
                    - The model was saved using :func:`~adapter_transformers.TFPreTrainedModel.save_pretrained` and is reloaded

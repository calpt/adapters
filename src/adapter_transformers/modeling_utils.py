...
class ModuleUtilsMixin:
    ...
    def reset_memory_hooks_state(self):
        ...
        :func:`~adapter_transformers.modeling_utils.ModuleUtilsMixin.add_memory_hooks`).
        """
        for module in self.modules():
    ...
    def floating_point_ops(
        ...
        <https://arxiv.org/pdf/2001.08361.pdf>`__ section 2.1. Should be overridden for adapter_transformers with parameter
...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, PushToHubMixin):
    ...
    :class:`~adapter_transformers.PreTrainedModel` takes care of storing the configuration of the models and handles methods
    ...
    Class attributes (overridden by derived classes):
        ...
        - **config_class** (:class:`~adapter_transformers.PretrainedConfig`) -- A subclass of
          :class:`~adapter_transformers.PretrainedConfig` to use as configuration class for this model architecture.
        - **load_tf_weights** (:obj:`Callable`) -- A python `method` for loading a TensorFlow checkpoint in a PyTorch
          model, taking as arguments:

            - **model** (:class:`~adapter_transformers.PreTrainedModel`) -- An instance of the model on which to load the
              TensorFlow checkpoint.
            - **config** (:class:`~adapter_transformers.PreTrainedConfig`) -- An instance of the configuration associated to
              the model.
    ...
    def save_pretrained(
        ...
        **kwargs,
        ...
        `:func:`~adapter_transformers.PreTrainedModel.from_pretrained`` class method.
        ...
        Arguments:
            ...
            kwargs:
                ...
                :meth:`~adapter_transformers.file_utils.PushToHubMixin.push_to_hub` method.
        """
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        Parameters:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`, `optional`):
                Can be either:
                    ...
                    - A path to a `directory` containing model weights saved using
                      :func:`~adapter_transformers.PreTrainedModel.save_pretrained`, e.g., ``./my_model_directory/``.
            ...
            config (:obj:`Union[PretrainedConfig, str, os.PathLike]`, `optional`):
                Can be either:
                    ...
                    - an instance of a class derived from :class:`~adapter_transformers.PretrainedConfig`,
                    - a string or path valid as input to :func:`~adapter_transformers.PretrainedConfig.from_pretrained`.
                ...
                be automatically loaded when:
                    ...
                    - The model is a model provided by the library (loaded with the `model id` string of a pretrained
                      model).
                    - The model was saved using :func:`~adapter_transformers.PreTrainedModel.save_pretrained` and is reloaded
            ...
            state_dict (:obj:`Dict[str, torch.Tensor]`, `optional`):
                ...
                :func:`~adapter_transformers.PreTrainedModel.save_pretrained` and
                :func:`~adapter_transformers.PreTrainedModel.from_pretrained` is not a simpler option.
            ...
            _fast_init(:obj:`bool`, `optional`, defaults to `:obj:`True`):
                ...
                .. warning::
                    ...
                    ``adapter_transformers.__version__ < 4.6.0`` for seeded model initialization. This argument will be removed
                    at the next major version. See `pull request 11471
                    <https://github.com/huggingface/adapter_transformers/pull/11471>`__ for more information.
            ...
            kwargs (remaining dictionary of keyword arguments, `optional`):
                ...
                automatically loaded:
                    ...
                    - If a configuration is not provided, ``kwargs`` will be first passed to the configuration class
                      initialization function (:func:`~adapter_transformers.PretrainedConfig.from_pretrained`). Each key of
        ...
        .. note::
            ...
            <https://huggingface.co/adapter_transformers/installation.html#offline-mode>`__ to use this method in a firewalled
            environment.
...
class PoolerStartLogits(nn.Module):
    ...
    Args:
        config (:class:`~adapter_transformers.PretrainedConfig`):
...
class SquadHeadOutput(ModelOutput):
    """
    Base class for outputs of question answering models using a :class:`~adapter_transformers.modeling_utils.SQuADHead`.
...
def prune_conv1d_layer(layer: Conv1D, index: torch.LongTensor, dim: int = 1) -> Conv1D:
    ...
    Args:
        layer (:class:`~adapter_transformers.modeling_utils.Conv1D`): The layer to prune.
        index (:obj:`torch.LongTensor`): The indices to keep in the layer.
        dim (:obj:`int`, `optional`, defaults to 1): The dimension on which to keep the indices.

    Returns:
        :class:`~adapter_transformers.modeling_utils.Conv1D`: The pruned layer as a new layer with :obj:`requires_grad=True`.
    """
    index = index.to(layer.weight.device)
    W = layer.weight.index_select(dim, index).clone().detach()
    if dim == 0:
...
def prune_layer(
    ...
    Returns:
        :obj:`torch.nn.Linear` or :class:`~adapter_transformers.modeling_utils.Conv1D`: The pruned layer as a new layer with

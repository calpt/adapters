...
LOGITS_PROCESSOR_INPUTS_DOCSTRING = r"""
    Args:
        input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            Indices can be obtained using :class:`~adapter_transformers.BertTokenizer`. See
            :meth:`adapter_transformers.PreTrainedTokenizer.encode` and :meth:`adapter_transformers.PreTrainedTokenizer.__call__` for
            details.
...
class LogitsProcessorList(list):
    """
    This class can be used to create a list of :class:`~adapter_transformers.LogitsProcessor` or
    :class:`~adapter_transformers.LogitsWarper` to subsequently process a :obj:`scores` input tensor. This class inherits from
    list and adds a specific `__call__` method to apply each :class:`~adapter_transformers.LogitsProcessor` or
    :class:`~adapter_transformers.LogitsWarper` to the inputs.
    """
...
class MinLengthLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adapter_transformers.LogitsProcessor` enforcing a min-length by setting EOS probability to 0.
...
class TemperatureLogitsWarper(LogitsWarper):
    r"""
    :class:`adapter_transformers.LogitsWarper` for temperature (exponential scaling output probability distribution).
...
class RepetitionPenaltyLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adapter_transformers.LogitsProcessor` enforcing an exponential penalty on repeated sequences.
...
class TopPLogitsWarper(LogitsWarper):
    """
    :class:`adapter_transformers.LogitsWarper` that performs top-p, i.e. restricting to top tokens summing to prob_cut_off <=
    prob_cut_off.
...
class TopKLogitsWarper(LogitsWarper):
    r"""
    :class:`adapter_transformers.LogitsWarper` that performs top-k, i.e. restricting to the k highest probability elements.
...
class NoRepeatNGramLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adapter_transformers.LogitsProcessor` that enforces no repetition of n-grams. See `Fairseq
...
class EncoderNoRepeatNGramLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adapter_transformers.LogitsProcessor` that enforces no repetition of encoder input ids n-grams for the decoder ids.
...
class NoBadWordsLogitsProcessor(LogitsProcessor):
    """
    :class:`adapter_transformers.LogitsProcessor` that enforces that specified sequences will never be sampled.
...
class PrefixConstrainedLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adapter_transformers.LogitsProcessor` that enforces constrained generation and is useful for prefix-conditioned
...
class HammingDiversityLogitsProcessor(LogitsProcessor):
    r"""
    :class:`adapter_transformers.LogitsProcessor` that enforces diverse beam search. Note that this logits processor is only
    effective for :meth:`adapter_transformers.PreTrainedModel.group_beam_search`. See `Diverse Beam Search: Decoding Diverse
...
class ForcedBOSTokenLogitsProcessor(LogitsProcessor):
    r"""
    :class:`~adapter_transformers.LogitsProcessor` that enforces the specified token as the first generated token.
...
class ForcedEOSTokenLogitsProcessor(LogitsProcessor):
    r"""
    :class:`~adapter_transformers.LogitsProcessor` that enforces the specified token as the last generated token when
...
class InfNanRemoveLogitsProcessor(LogitsProcessor):
    r"""
    :class:`~adapter_transformers.LogitsProcessor` that removes all :obj:`nan` and :obj:`inf` values to avoid the generation
